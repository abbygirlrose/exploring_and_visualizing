...
ggplot(likely_all, aes(x = race, y = n, fill = intent)) + geom_col(position = "fill") + labs(title = "Comparison of Homicide vs. Suicide over Whites, Blacks, and Hispanics", x = "Race", y = "Gun Deaths")
...
ggplot(race_police, aes(x = police, y = n, fill = race)) + geom_col(position = "fill") + labs("Police Involved vs Non Police Involved Deaths, By Race, 2012-14", y = "Percentage of Gun Deaths", x = "Police Involved?") 
  
#All three variables

ggplot(gun_deaths, aes(x=age, y=race), color = police) + geom_boxplot()
```
