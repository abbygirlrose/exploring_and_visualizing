...
print("Summer had the most gun deaths")
...
ggplot(race_police, aes(x = bypolice, y = n, fill = race)) + geom_col(position = "fill") + labs("Police Involved vs Non Police Involved Deaths, By Race, 2012-14", y = "Percentage of Gun Deaths", x = "Shooting Type") + scale_y_continuous(labels = scales::percent)
                                                                                            #All three variables
